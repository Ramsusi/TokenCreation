...
contract RSToken is ERC20, ERC20Capped, ERC20Burnable, Ownable{
    //Define the max supply
    uint256 public maxSupply=1000000000;
    uint256 public _totalSupplyAll;
    constructor() ERC20("RSToken","RS") ERC20Capped(maxSupply) Ownable(msg.sender){
        //Initialize the Maximum Supply
        //Max Supply = 1000000000;

        //Mint the initial Supply
        uint256 initialSupply=700000000 * 10**decimals();
